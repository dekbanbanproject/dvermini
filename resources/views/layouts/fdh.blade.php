        ...
        <header id="page-topbar">
            {{-- <div class="navbar-header shadow-lg" style="background-color: rgb(252, 252, 252)"> --}}
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box" style="background-color: rgb(255, 255, 255)">
                        <a href="" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                ...
                                <h4 style="color:pink" class="mt-4">Dver-Mini</h4>
                            </span>
                        </a>
                        ...
                        <a href="" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <h4 style="color:rgba(21, 177, 164, 0.871)" class="mt-4">Dver-Mini</h4>
                            </span>
                        </a>
                    </div>
                    ...
                    <a href="{{url('fdh_main')}}">
                        <h4 style="color:rgb(255, 255, 255)" class="mt-4">Dver-Mini FDH</h4>
                    </a>
